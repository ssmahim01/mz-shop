...
const Banner = () => {
    ...
    return (
        <div className="lg:px-40 px-10 lg:pt-20 pt-10 lg:h-[550px] md:h-[500px] h-[410px] my-2">
            <div className="flex flex-col justify-center items-center md:gap-8 gap-4">
                <h2 className="lg:text-5xl md:text-3xl text-xl text-white font-bold text-center">Upgrade Your Tech Accessorize with Gadget Heaven Accessories</h2>
