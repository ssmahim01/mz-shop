const Footer = () => {
  return (
    <footer className="flex flex-col justify-center items-center gap-6 text-center bg-base-100 text-base-content rounded p-10">
      ...
      <div className="flex flex-wrap justify-between items-center lg:px-10 lg:mt-0 mt-8 lg:-space-y-9 space-y-4">
        ...
        <nav className="flex flex-col gap-2 text-gray-500 font-medium lg:ml-36 ml-3">
